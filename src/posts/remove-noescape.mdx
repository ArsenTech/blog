...
Now mention every single file on desktop planted by NoEscape.exe using **Ctrl + A** and delete these files using **Shift + Del**. Don't forget to empty the recycle bin.
