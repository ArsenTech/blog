...
- [Watch the video on YouTube](https://youtu.be/n_I6Eavmxuo)
- [Watch the YT Short about making bootable USB](https://youtube.com/shorts/hteU98FN3Gc?feature=share)
...
Type `diskpart` and hit Enter <Kbd>⏎</Kbd>, and then click on `Yes` if the UAC prompt appears.
